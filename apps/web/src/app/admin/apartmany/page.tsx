  ...
  return (
    <div className="min-h-screen bg-stone">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <div className="flex gap-6 mt-3 text-xs text-slate-500">
              ...
              <span>Rental program: <strong className="text-navy">{inProgram}</strong></span>
            </div>
          </div>
          <AddApartmentForm />
        </div>
        ...
        {/* Legenda */}
        <div className="bg-white border border-stone px-4 py-3 mb-4 text-xs text-slate-500 flex gap-6">
