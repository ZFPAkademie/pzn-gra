                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-navy font-medium">Michal Novotný</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-stone-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                      <a href="mailto:michal.novotny@zfpa.cz" className="text-navy hover:text-slate-700">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <a href="tel:+420736242624" className="text-navy hover:text-slate-700">
                        +420 736 242 624
                      </a>
                    </div>
                  </div>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-navy font-medium">Golden Ridge Apartments</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-stone-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
