 ...
 * URL: /podil/50 = 50 dostupných (default)
 */
...
export const metadata: Metadata = {
  ...
  description: 'Získejte družstevní podíl na horském apartmánu č. 7 ve Špindlerově Mlýně.',
};
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16">
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {apartment.features.map((feature, index) => (
                  <span key={index} className="px-3 py-1.5 bg-navy/5 text-navy text-sm">
                    {feature}
                  </span>
                ))}
              </div>
            ...
            <div className="bg-white p-8 border border-navy/10">
              <h3 className="text-sm text-navy/40 uppercase tracking-widest mb-6">Specifikace</h3>
      ...
      <section className="py-24 bg-stone">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl font-light text-navy mb-4">Výhody družstevního podílu</h2>
          </div>
