/**
 * Apartmány na prodej - Design 2030
 */
...
export const metadata: Metadata = {
  ...
  description: 'Luxusní apartmány na prodej ve Špindlerově Mlýně, přímo u lanovky Labská.',
};

export default function SaleApartmentsPage() {
