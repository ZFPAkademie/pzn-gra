...
| Stránka podíl | ✅ | Dynamické URL |
| Lead capture | ✅ | 4 typy leadů |
| Admin inbox | ✅ | Základní |
| Supabase Storage | ✅ | Fotky |

### 🚧 K implementaci
| Komponenta | Priorita | Závislosti |
|------------|----------|------------|
| Booking engine | HIGH | Stripe |
| Channel manager | HIGH | Booking.com API |
| Klientský portál | MEDIUM | Auth, RLS |
| Admin dashboard v2 | MEDIUM | Portál |
| SVJ modul | MEDIUM | Portál |
| Stripe Connect | HIGH | Portál |
